...
fn interface_monitor_report(connection: db::Connection, imds: State<Arc<Mutex<utilities::imds::IMDS>>>, interface_monitor_report : Json<models::json::InterfaceMonitorReport>) {
