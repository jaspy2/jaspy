...
parser.add_argument('-c', '--community', required=True, help='snmp community', default=os.environ.get('JASPY_COMMUNITY', None))
parser.add_argument('-r', '--root-device', required=True, help='root device for discovery', default=os.environ.get('JASPY_ROOT_DEVICE', None))
parser.add_argument('-d', '--dns-domain', required=True, help='dnsdomains',action='append', default=[os.environ.get('JASPY_DNS_DOMAIN', None)])
