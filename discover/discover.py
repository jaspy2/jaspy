...
parser.add_argument('-s', '--snmpbot-url', required=False, help='url for snmpbot', default=os.environ.get('JASPY_SNMPBOT_URL', 'http://localhost:8286'))
parser.add_argument('-j', '--jaspy-url', required=False, help='url for jaspy', default=os.environ.get('JASPY_URL', 'http://localhost:8000'))
parser.add_argument('-c', '--community', required=False, help='snmp community', default=os.environ.get('JASPY_COMMUNITY', None))
parser.add_argument('-r', '--root-device', required=False, help='root device for discovery', default=os.environ.get('JASPY_ROOT_DEVICE', None))
parser.add_argument('-d', '--dns-domain', required=False, help='dnsdomains',action='append', default=[os.environ.get('JASPY_DNS_DOMAIN', None)])
